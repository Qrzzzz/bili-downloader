...
try {
    ...
    if ([string]$playwrightResult.browser -ne "playwright-chromium" -or
        [string]$playwrightResult.page_url -ne "about:blank") {
        throw "Packaged Playwright smoke did not use the bundled Chromium about:blank path."
    }
